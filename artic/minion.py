...
def run(parser, args):
    ...
    if not args.medaka and not args.skip_nanopolish:
        ...
        cmds.append(
            ...
            % (args.sequencing_summary, args.fast5_directory, args.read_file,)
        )
    ...
    if args.medaka and not args.no_longshot:
        ...
        cmds.append(
            "longshot -P 0 -F --max_cov 200000 --no_haps --bam %s.primertrimmed.rg.sorted.bam --ref %s --out %s.merged.vcf --potential_variants %s.merged.vcf.gz"
